...
helm verssion --> to know version of api

Helm ls --> to list the releases installed

helm uninstall release-1 --> to unistall a relase releted all objects (DC, Pods)

helm status release-1 --> to check status of a release
